...
while(cap.isOpened()):
    ...
    # if count_defects == 1:
    #     cv2.putText(img,"I am Dien", (50, 50), cv2.FONT_HERSHEY_SIMPLEX, 2, 2)
    ...
    if count_defects != 0: cv2.putText(img,"ON",(50 , 50),cv2.FONT_HERSHEY_COMPLEX, 2,2)
    else : cv2.putText(img,"OFF",(50 , 50),cv2.FONT_HERSHEY_COMPLEX, 2,2)
